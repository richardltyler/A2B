...
//   it.skip('should instantiate the Destination class', function() {
...
//   it.skip('should initialize with a location', function() {
//     expect(destination1.location).to.eq(destionationData[0].destination);
//     expect(destination2.location).to.eq(destionationData[1].destination);
//   })
  
//   it.skip('should initialize with a rough lodging cost', function() {
//     expect(destination1.estimatedLodgingCostPerDay).to.eq(70);

//     expect(destination2.estimatedLodgingCostPerDay).to.eq(100);
//   })

//   it.skip('should initialize with a rough flight cost', function() {
//     expect(destination1.estimatedFlightCostPerDay).to.eq(400);

//     expect(destination2.estimatedFlightCostPerDay).to.eq(780);
//   })
...
//   it.skip('should initialize with alt text', function() {
